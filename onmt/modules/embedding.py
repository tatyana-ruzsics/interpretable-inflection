...
class InflectionLSTMEncoder(nn.Module):
    ...
    # def __init__(self, embedding, out_size, bidirectional=True, fused_msd =False, **kwargs):
    ...
    def forward(self, input, **kwargs):
        ...
        # if self.fused_msd:
        #     fused_msd = torch.mean(emb, 0, keepdim=True)
        #     emb = torch.cat((emb,fused_msd),dim=0)
